...
""",
    ...
    def assertRaisesScriptDestroyed(self, operation):
        self.assertRaisesRegex(miru.InvalidOperationError, "script has been destroyed", operation)

    def assertRaisesOperationCancelled(self, operation):
        self.assertRaisesRegex(miru.OperationCancelledError, "operation was cancelled", operation)
